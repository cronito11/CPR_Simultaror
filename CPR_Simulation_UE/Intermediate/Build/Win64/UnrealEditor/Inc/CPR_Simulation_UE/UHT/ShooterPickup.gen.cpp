...
CPR_SIMULATION_UE_API UClass* Z_Construct_UClass_AShooterPickup();
...
CPR_SIMULATION_UE_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponTableRow();
...
class UScriptStruct* FWeaponTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FWeaponTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponTableRow, (UObject*)Z_Construct_UPackage__Script_CPR_Simulation_UE(), TEXT("WeaponTableRow"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"),&Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 3150517445U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 1221387224U) },
	};
}; // Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_2707754048{
	TEXT("/Script/CPR_Simulation_UE"),
	Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Centennial_Simulation_CPR_Simulation_CPR_Simulation_UE_Source_CPR_Simulation_UE_Variant_Shooter_Weapons_ShooterPickup_h__Script_CPR_Simulation_UE_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
